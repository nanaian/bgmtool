// https://github.com/PistonDevelopers/conrod/blob/master/backends/conrod_glium/examples/support/mod.rs
...
// Conversion functions for converting between types from glium's version of `winit` and `conrod_core`.
